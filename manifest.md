...
- **`layers`** *array*
    ...
    - **`mediaType`** *string*
        ...
        - [`application/vnd.oci.image.layer.aufs.v1.tar+gzip`](layer.md)
        - [`application/vnd.oci.image.layer.nondistributable.aufs.v1.tar+gzip`](layer.md#non-distributable-layers)
...
```json,title=Manifest&mediatype=application/vnd.oci.image.manifest.v1%2Bjson
{
  ...
  "layers": [
    {
      "mediaType": "application/vnd.oci.image.layer.aufs.v1.tar+gzip",
      "size": 32654,
